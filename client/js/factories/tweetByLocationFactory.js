angular.module('tweet_by_location', []).factory('Data', function($http, $window) {
  ...
  var methods = {
    getTweetsByLocation: function(location) {
      return $http.post('https://glacial-gorge-85229.herokuapp.com/api/tweets_by_location', location, {
        headers: {
          'Authorization': 'Bearer ' + token
        }
      });
    ...
    getTrendsByLocation: function(location) {
      return $http.post('https://glacial-gorge-85229.herokuapp.com/api/trends_by_location', location, {
        headers: {
          'Authorization': 'Bearer ' + token
        }
      });
